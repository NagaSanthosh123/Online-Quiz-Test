  ...
  $_SESSION['test']='pt3';
    //$_SESSION['javatest1']='start';
     if(!isset($_SESSION['refresh'])){
      ...
      $id=$_SESSION['id'];
      $i1=$arr[$_SESSION['test']];
      $servername="localhost";
      $username="root";
      $password="";
      $databasename="miniproject";
      $conn=new mysqli($servername,$username,$password,$databasename);
      $sql="Insert into results values(10,0,0,10,$i1,'$id')";
      $conn->query($sql);
...
countdown( "ten-countdown", 10, 0 );
    ...
    <h1>Test on Python<span class="badge bg-secondary">New</span></h1>
